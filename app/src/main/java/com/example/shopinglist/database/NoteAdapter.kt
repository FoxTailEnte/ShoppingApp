...
import com.example.shopinglist.databinding.NotListItemBinding
...
class NoteAdapter(private val listener: Listener, private val defPref: SharedPreferences) :
    ...
    class ItemHolder(view: View) : RecyclerView.ViewHolder(view) {
        private val binding = NotListItemBinding.bind(view)
        ...
        fun setData(note: NoteItem, listener: Listener, defPref: SharedPreferences) = with(binding) {
            ...
            imDeleteNote.setOnClickListener {
            ...
            fun create(parent: ViewGroup): ItemHolder {
                return ItemHolder(
                    LayoutInflater.from(parent.context)
                        .inflate(R.layout.not_list_item, parent, false)
                )
            }
        }
    }
